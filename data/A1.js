...
export const A1_MODULES = [
  ...
  /* ── M01 — Saudações e despedidas ── */
  {
    ...
    descricao: 'As primeiras palavras que você precisa saber',
    xpTotal: 150,
    exercicios: [
      { tipo: 'intro', audio_pt: 'Neste módulo você vai aprender as saudações essenciais do italiano — quando usá-las e como não errar entre formal e informal.' },
      { tipo: 'vocab', it: 'Ciao', pt: 'Oi / Tchau', ctx: 'Informal. Use com amigos e família. Serve para chegar e para ir embora.', xp: 5 },
      { tipo: 'vocab', it: 'Buongiorno', pt: 'Bom dia', ctx: 'Formal e informal. Use até por volta das 13h — em lojas, escritórios ou com desconhecidos.', xp: 5 },
      { tipo: 'vocab', it: 'Buonasera', pt: 'Boa tarde / Boa noite', ctx: 'A partir das 13h. Em italiano, "buonasera" cobre tanto boa tarde quanto boa noite ao chegar.', xp: 5 },
      { tipo: 'vocab', it: 'Buonanotte', pt: 'Boa noite (ao dormir)', ctx: 'Apenas ao se despedir antes de dormir — não é cumprimento de chegada.', xp: 5 },
      { tipo: 'vocab', it: 'Salve', pt: 'Olá (neutro)', ctx: 'Neutro entre formal e informal. Ótimo quando você não sabe qual usar.', xp: 5 },
      { tipo: 'vocab', it: 'Arrivederci', pt: 'Até logo (formal)', ctx: 'Despedida formal. Em lojas, consultórios e com desconhecidos.', xp: 5 },
      { tipo: 'vocab', it: 'A presto / A domani', pt: 'Até logo / Até amanhã', ctx: '"A presto" quando vai se ver em breve. "A domani" quando é no dia seguinte. Ambos informais.', xp: 5 },
      { tipo: 'frase', it: 'Buongiorno, come sta?', pt: 'Bom dia, como o senhor está?', ctx: '"Come sta?" usa o Lei — forma de respeito. Com amigos: "Come stai?"', xp: 5 },
      { tipo: 'formal_vs_informal', situacao: 'Perguntar "como vai?"', informal: { it: 'Come stai?', pt: 'Como você está?' }, formal: { it: 'Come sta?', pt: 'Como o senhor está?' }, regra: 'Informal usa "stai" (tu). Formal usa "sta" (Lei). Esta diferença aparece em todos os verbos.', xp: 15 },
      { tipo: 'dialogo', titulo: 'Encontro formal', linhas: [
        { personagem: 'A', it: 'Buongiorno! Come sta?', pt: 'Bom dia! Como o senhor está?' },
        { personagem: 'B', it: 'Bene, grazie. E Lei?', pt: 'Bem, obrigado. E o senhor?' },
        { personagem: 'A', it: 'Molto bene, grazie. Arrivederci!', pt: 'Muito bem, obrigado. Até logo!' },
        { personagem: 'B', it: 'Arrivederci! Buona giornata.', pt: 'Até logo! Tenha um bom dia.' },
      ], xp: 20 },
      { tipo: 'dialogo', titulo: 'Encontro entre amigos', linhas: [
        { personagem: 'A', it: 'Ciao Marco! Come stai?', pt: 'Oi Marco! Como vai?' },
        { personagem: 'B', it: 'Ciao! Sto bene, e tu?', pt: 'Oi! Estou bem, e você?' },
        { personagem: 'A', it: 'Benissimo! A domani, ciao!', pt: 'Ótimo! Até amanhã, tchau!' },
        { personagem: 'B', it: 'Ciao! A presto!', pt: 'Tchau! Até logo!' },
      ], xp: 20 },
      { tipo: 'quiz', pergunta_pt: 'Como diz "boa tarde/noite" em italiano ao chegar?', it: 'Buonasera', pt: 'Boa tarde / noite', opcoes: ['Buongiorno', 'Buonasera', 'Buonanotte', 'Arrivederci'], correta: 1, xp: 10 },
      { tipo: 'quiz_oral', pergunta_pt: 'Como se despede formalmente em italiano?', resposta_it: 'Arrivederci', resposta_pt: 'Até logo', pausa_segundos: 3, xp: 8 },
    ],
  },
