...
export const B1_MODULES = [
  ...
  /* ── M39 — Condizionale ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz', pergunta_pt: 'Como diz educadamente "Eu gostaria de um café"?', opcoes: ['Voglio un caffè.', 'Vorrei un caffè.', 'Volevo un caffè.', 'Vorrò un caffè.'], correta: 1, it: 'Vorrei un caffè, per favore.', pt: 'Gostaria de um café, por favor.', xp: 10 },
  ...
  /* ── M44 — Tu vs Lei uso avanzato ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz', pergunta_pt: 'Qual é a forma correta do Lei para "Come stai?"?', opcoes: ['Come stai?', 'Come sta?', 'Come stanno?', 'Come siete?'], correta: 1, it: 'Come sta, signore/signora?', pt: 'Como o senhor/a senhora está?', xp: 10 },
      { tipo: 'quiz_oral', pergunta_pt: 'Proponha a um cliente usar o "tu" em vez do "Lei".', resposta_it: 'Possiamo darci del tu? Mi sentirei più a mio agio.', resposta_pt: 'Podemos usar o tu? Me sentiria mais à vontade.', pausa_segundos: 4, xp: 8 },
    ],
  },
  ...
  /* ── M46 — Riunioni e presentazioni ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz', pergunta_pt: 'Como discordar de forma educada numa reunião formal?', opcoes: ['Sei completamente sbagliato!', 'Mi permetto di dissentire: i dati mostrano qualcosa di diverso.', 'Non sono d\'accordo per niente.', 'Aspetta, questo non ha senso.'], correta: 1, it: 'Mi permetto di dissentire.', pt: 'Permito-me discordar.', xp: 10 },
  ...
  /* ── M47 — Gergo e linguaggio informale ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz', pergunta_pt: 'O que significa "Ce la fai!" em italiano?', opcoes: ['Você aguenta!', 'Você consegue!', 'Você entende!', 'Você vai!'], correta: 1, it: 'Ce la fai! / Ce la faccio!', pt: 'Você consegue! / Eu consigo!', xp: 10 },
  ...
  /* ── M48 — Parolacce e registro ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz_oral', pergunta_pt: 'Diga 3 interjeições italianas suaves que pode usar em qualquer lugar.', resposta_it: 'Cavolo! Accidenti! Mannaggia!', resposta_pt: 'Caramba! Droga! Poxa!', pausa_segundos: 4, xp: 8 },
    ],
  },
  ...
  /* ── M49 — Medico e emergenze ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz', pergunta_pt: 'Qual é o número de emergência da ambulância na Itália?', opcoes: ['112', '115', '118', '113'], correta: 2, it: 'Il centodiciotto — 118.', pt: 'O 118 é o número da ambulância na Itália. (113 = Polizia, 115 = Vigili del fuoco)', xp: 10 },
  ...
  /* ── M50 — Banca e finanza ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz', pergunta_pt: 'Como se chama o cartão de débito na Itália (nome comum)?', opcoes: ['Carta di credito', 'Bancomat', 'Assegno', 'Bonifico'], correta: 1, it: 'Il bancomat', pt: 'O cartão de débito / caixa eletrônico (marca que virou nome genérico)', xp: 10 },
  ...
  /* ── M51 — Contratti e burocrazia ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz', pergunta_pt: 'O que é o "codice fiscale" italiano?', opcoes: ['Código postal', 'CPF italiano — código de identificação fiscal', 'Código de segurança do cartão', 'Número de passaporte'], correta: 1, it: 'Il codice fiscale', pt: 'O código fiscal italiano — equivalente ao CPF. Sequência de 16 caracteres (letras + números).', xp: 10 },
  ...
  /* ── M52 — Opinioni e dibattito ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz', pergunta_pt: 'Qual fórmula mais formal para dizer "na minha opinião"?', opcoes: ['Secondo me', 'A mio avviso / A mio parere', 'Io penso che', 'Per me'], correta: 1, it: 'A mio avviso / A mio parere', pt: 'Na minha opinião (mais formal — para debates, emails, reuniões)', xp: 10 },
  ...
  /* ── M53 — Cultura italiana ── */
  {
    ...
    exercicios: [
      ...
      { tipo: 'quiz', pergunta_pt: 'O que é "campanilismo" em italiano?', opcoes: ['Tocar o sino da Igreja', 'Orgulho excessivo pela própria cidade ou região', 'Festival de música regional', 'Arquitetura de torre medieval'], correta: 1, it: 'Il campanilismo', pt: 'O orgulho excessivo pela própria cidade — vem de "campanile" (torre do sino).', xp: 10 },
